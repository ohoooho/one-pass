...
const originList = "https://share.one-pass.ohoooho.com,https://demo.one-pass.ohoooho.com,https://deploy-preview-*--one-pass.netlify.app"
...
func TestAllowedOrigin(t *testing.T) {
	...
	tests := []struct {
		...
		{"https://share.one-pass.ohoooho.com", true},
		{"https://demo.one-pass.ohoooho.com", true},
		{"https://deploy-preview-3577--one-pass.netlify.app", true},
		{"https://deploy-preview-1--one-pass.netlify.app", true},
		{"http://share.one-pass.ohoooho.com", false},
		{"https://one-pass.ohoooho.com", false},
		{"https://evil.example.com", false},
		{"https://deploy-preview-3577--one-pass.netlify.app.evil.com", false},
		{"https://deploy-preview-x.evil.com--one-pass.netlify.app", false},
		{"https://share.one-pass.ohoooho.com.evil.com", false},
		{"", false},
	}
...
func TestWithCORS(t *testing.T) {
	...
	t.Run("allowed origin is echoed", func(t *testing.T) {
		...
		req.Header.Set("Origin", "https://share.one-pass.ohoooho.com")
		rec := httptest.NewRecorder()
		handler.ServeHTTP(rec, req)

		if got := rec.Header().Get("Access-Control-Allow-Origin"); got != "https://share.one-pass.ohoooho.com" {
			t.Errorf("Access-Control-Allow-Origin = %q, want %q", got, "https://share.one-pass.ohoooho.com")
		}
	...
	t.Run("implicit WriteHeader via Write", func(t *testing.T) {
		...
		req.Header.Set("Origin", "https://demo.one-pass.ohoooho.com")
		rec := httptest.NewRecorder()
		plain.ServeHTTP(rec, req)

		if got := rec.Header().Get("Access-Control-Allow-Origin"); got != "https://demo.one-pass.ohoooho.com" {
			t.Errorf("Access-Control-Allow-Origin = %q, want %q", got, "https://demo.one-pass.ohoooho.com")
		}
	})
}
