# CDK configuration for deploying onepass in AWS.

This is __primarily__ for the project itself and needs alterations to be used in your own setup.

## One-time setup

The stack resolves the onepass license key from SSM Parameter Store at deploy time:
...
CORS is restricted to the official frontends (`share.onepass.se`, `demo.onepass.se`)
and Netlify deploy previews (`deploy-preview-*--onepass.netlify.app`). Origins are
