...
func TestSecretJSON(t *testing.T) {
	got, err := (&onepass.Secret{Expiration: 3600, Message: "msg", OneTime: true}).ToJSON()
	if err != nil {
		t.Fatal(err)
	}
...
func TestSecretURL(t *testing.T) {
	tests := []struct {
		...
		{
			name: "regular",
			url:  "https://one-pass.ohoooho.com",
			id:   "b961103f-5a54-4aae-94b8-dccb903802bc",
			key:  "X9eSZdgUOXSJ3ft0TXAfWT",
			want: "https://one-pass.ohoooho.com/#/s/b961103f-5a54-4aae-94b8-dccb903802bc/X9eSZdgUOXSJ3ft0TXAfWT",
		},
		{
			name: "trailing slash",
			url:  "https://one-pass.ohoooho.com/",
		...
		},
		{
			...
			key:  "manual-key",
			kOpt: true,
			want: "https://one-pass.ohoooho.com/#/s/6cb3b277-dadd-47c5-b118-d49824b40e15",
		},
		{
			name: "file upload",
			url:  "https://one-pass.ohoooho.com",
			...
			fOpt: true,
			want: "https://one-pass.ohoooho.com/#/f/c680736d-32ff-4e1a-a18f-3a20e6774616/ZMprbkA78FkEWAbrXKK06y",
		},
		{
			...
			fOpt: true,
			kOpt: true,
			want: "https://one-pass.ohoooho.com/#/f/7a43c54c-6dad-4f98-b422-589021d1ac87",
		},
		{
			name: "base62 ID",
			url:  "https://one-pass.ohoooho.com",
			...
			key:  "X9eSZdgUOXSJ3ft0TXAfWT",
			want: "https://one-pass.ohoooho.com/#/s/0A1b2C3d4E5f6G7h8I9j0K/X9eSZdgUOXSJ3ft0TXAfWT",
		},
	}

	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			have := onepass.SecretURL(tt.url, tt.id, tt.key, tt.fOpt, tt.kOpt)
			if tt.want != have {
...
func TestParseURL(t *testing.T) {
	tests := []struct {
		...
		{
			name: "regular",
			url:  "https://one-pass.ohoooho.com/#/s/45d405ef-5c52-46c1-86d2-2d270c5b1b19/sLYp6skAIhkUnfUMimVU5O",
		...
		{
			name:   "manual key",
			url:    "https://one-pass.ohoooho.com/#/c/2c625fd2-84b5-4a02-a6bf-23a2939eea4f",
			id:     "2c625fd2-84b5-4a02-a6bf-23a2939eea4f",
			keyOpt: true,
		},
		{
			name:    "file upload",
			url:     "https://one-pass.ohoooho.com/#/f/c680736d-32ff-4e1a-a18f-3a20e6774616/ZMprbkA78FkEWAbrXKK06y",
			id:      "c680736d-32ff-4e1a-a18f-3a20e6774616",
			key:     "ZMprbkA78FkEWAbrXKK06y",
			fileOpt: true,
		},
		{
			name:    "file upload with manual key",
			url:     "https://one-pass.ohoooho.com/#/d/7a43c54c-6dad-4f98-b422-589021d1ac87",
			id:      "7a43c54c-6dad-4f98-b422-589021d1ac87",
			fileOpt: true,
			keyOpt:  true,
		},
		{
			name: "base62 ID",
			url:  "https://one-pass.ohoooho.com/#/s/0A1b2C3d4E5f6G7h8I9j0K/sLYp6skAIhkUnfUMimVU5O",
			id:   "0A1b2C3d4E5f6G7h8I9j0K",
			key:  "sLYp6skAIhkUnfUMimVU5O",
		},
		{
			name:    "base62 ID file",
			url:     "https://one-pass.ohoooho.com/#/f/0A1b2C3d4E5f6G7h8I9j0K/ZMprbkA78FkEWAbrXKK06y",
			id:      "0A1b2C3d4E5f6G7h8I9j0K",
			key:     "ZMprbkA78FkEWAbrXKK06y",
			fileOpt: true,
		},
		...
		},
		{
			...
			url:  "https://one-pass.ohoooho.com/#/z/7a43c54c-6dad-4f98-b422-589021d1ac87",
			fail: true,
		},
	}
