...
func (m *Memcached) Status(key string) (onepass.Secret, error) {
...
func (m *Memcached) Get(key string) (onepass.Secret, error) {
	var s onepass.Secret
...
func (m *Memcached) Put(key string, secret onepass.Secret) error {
...
func (m *Memcached) Update(key string, fn func(onepass.Secret) (onepass.Secret, error)) error {
	var lastErr error
...
func (m *Memcached) Health() error {
	_, err := m.Client.Get("__onepass_health_check__")
